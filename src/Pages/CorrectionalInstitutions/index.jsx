      ...
      <div>
         <ContantContainerMain>
            ...
            <div className={`mt80 borderMain ${s.border}`}>
               <DocumentContainerDownload text='Московская прокуратура по надзору за соблюдением законов в исправительных учреждениях Московской области информирует о Государственной стратегии противодействия распространению ВИЧ-инфекции в Российской Федерации.' date={'06.02.2023'} />
               <DocumentContainerDownload text='Cтатья по разъяснению законодательству о потребительском кредите' date={'06.02.2023'} />
            </div>
