   ...
   return (
      <div>
         <ContantContainerMain>
            ...
            <h1 className="mt24 pageTitle">Общественная палата</h1>
            ...
            <div className={`mt38 text`}>
               ...
               <a href={'https://opmosreg.ru/munitsipalnye-op/13278/'} target="_blank" className={`mt38 oval`} rel="noreferrer">Общественная палата Московской области</a>
            </div>
         </ContantContainerMain>
      </div>
   )
