   ...
   return (
      <div>
         <ContantContainerMain>
            ...
            <h1 className={`mt24 h1`}>Памятники истории и культуры</h1>
               ...
               <div className="columnLarge">
                  ...
                  <div className={`mt80 ${s.mainTextContainer}`}>
                     ...
                     <div className={`mt38 text`}>
                        ...
                        <a href="https://yandex.ru/maps/org/sestra_miloserdiya/234362754138/?indoorLevel=1&ll=37.433950%2C55.889781&z=17.6" target='_blank' className={`mt38 btnWBanner ${s.btn}`} rel="noreferrer">Место на карте </a>
                     </div>
                     ...
                     <a href="https://yandex.ru/maps/org/memorial_geroyam_khimchanam/81901531130/?ll=37.453347%2C55.900145&z=16" target='_blank' className={`mt38 btnWBanner ${s.btn}`} rel="noreferrer">Место на карте </a>
                     ...
                     <div className={`mt38 text`}>
                        ...
                        <a href="https://yandex.ru/maps/org/otstoyavshim_otchiznu/50035484674/?ll=37.454645%2C55.900498&z=17" target='_blank' className={`mt38 btnWBanner ${s.btn}`} rel="noreferrer">Место на карте </a>
                     </div>
                  </div>
                  ...
                  <div className={` ${s.mainTextContainer}`}>
                     ...
                     <div className={`mt38 text`}>
                        ...
                        <a href="https://yandex.ru/maps/org/frontovoy_istrebitel_la_7/187030582354/?ll=37.417810%2C55.899812&z=15" target='_blank' className={`mt38 btnWBanner ${s.btn}`} rel="noreferrer">Место на карте </a>
                     </div>
                  </div>
                  ...
                  <div className={` ${s.mainTextContainer}`}>
                     ...
                     <div className={`mt38 text`}>
                        ...
                        <a href="https://yandex.ru/maps/10758/himki/?ll=37.429939%2C55.891131&mode=poi&poi%5Bpoint%5D=37.430191%2C55.891304&poi%5Buri%5D=ymapsbm1%3A%2F%2Forg%3Foid%3D51188788286&source=serp_navig&z=19.4" target='_blank' className={`mt38 btnWBanner ${s.btn}`} rel="noreferrer">Место на карте </a>
                     </div>
