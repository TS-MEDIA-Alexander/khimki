   ...
   return (
      <div>
         <ContantContainerMain>
            ...
            <div className={`mt24 pageTitle`}>Устав и символика</div>
            <div className={`mt80 ${s.subtitle}`}>Устав</div>
            <div className={`mt38 ${s.textBody}`}>Совет депутатов городского округа Химки Московской области
            ...
            <div className={`mt40 ${s.charterContainer}`}>
               <DocumentContainerDownload documentName={'15.04.2020_№_292.pdf'} text='Устав городского округа Химки Московской области' date="06.02.2023" />
            </div>
               ...
               <div className={s.flexContainer}>
                  ...
                  <div className={s.textContainer}>
                     <div className={`${s.textBodyCard}`}>
                        ...
                        <div className="mt24">
                           Химки – это территория новых возможностей. Здесь жизнь постоянно меняется к лучшему, здесь думают о людях и модернизируют инфраструктуру так, чтобы жителям ыло удобно и комфортно.
                        </div>
                     </div>
                     <a
                        href={logoDownload}
