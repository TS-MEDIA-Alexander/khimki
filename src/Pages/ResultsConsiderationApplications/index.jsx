      ...
      <div>
         <ContantContainerMain>
            <div className={`mt80 breadcrumbs`}>
               <NavLink to={ROUTER.news} className='breadcrumbsFrom'>Обращения граждан</NavLink>
            ...
            <div className="mt80 pageSubtitle">
               <p>Сведения по обращениям граждан, поступившим в администрацию городского округа</p>
               химки московской области за 2023 год и соответствующий период 2022 года
            </div>

            <div className="mt40">
               <Table table={rezultaty_rassmotreniya_obrascheniy_tablitsa} style={s} />
            </div>
